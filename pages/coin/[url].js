...
const Page = () => {
  ...
  return (
    <>
            ...
            <div className="w-full">
              <div className="flex flex-col lg:flex-row mx-auto w-full bg-white dark:bg-gray-800 shadow rounded">
                <div className="w-full lg:w-1/3 p-6">
                  ...
                  <div className="text-xs text-center w-3/4 bg-gray-300 dark:text-indigo-600 rounded font-medium p-3 lg:mr-3">
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-normal">
      ...
      {/*<div className="min-h-screen flex flex-col items-center justify-center bg-gray-700 py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-1/2 min-h-screen bg-white rounded-lg shadow-sm ">
        <div className="flex-shrink-0 p-5 flex flex-row items-stretch">
            <img
            ...
            />
            <h1 className="text-3xl font-medium text-gray-700">{coinInf.coin_name}</h1>
            <span className="text-white ml-10 text-2xl font-bold w-16 h-10 bg-gray-700 text-center rounded-xl">
            ${coinInf.coin_symbol}
            </span>
          </div>
          <div className="ml-4">
